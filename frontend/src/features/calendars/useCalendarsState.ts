...
export function useCalendarsState() {
  ...
  const {
    ...
    addAppleAccount,
    removeAppleAccount,
    listCalendarsForAccount: listCalendarsForAppleAccount,
    connectApple: connectAppleCalDav,
    disconnect: disconnectCalDav,
    updateInterval: updateCalDavInterval,
    syncNow: syncCalDavNow
